        ...
        return (
            <div>
                        <CardDeck>
                            {
                                this.props.main && 
                                <Col xs="12" sm="6" md="4" lg="3" xl="2" style={{'padding': '0px'}} key={this.props.main.text}>
                            ...
                            {   
                                this.props.products.map((product,i) =>{
                                        ...
                                        return(
                                        <Col xs="12" sm="6" md="4" lg="3" xl="2" style={{'padding': '0px'}} style={this.props.customStyle} className={`tiles ${colOffset}`} key={product.id}>
