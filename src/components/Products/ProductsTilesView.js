...
class ProductTilesView extends Component {
    render() {
        let colOffset = "";
        return (
                ...
                <CardDeck className="flex-grow-1 right-side-content">
                {
                    ...
                    }
                    {
                        this.props.products.map((product, i) => {
                            ...
                            return (
                                <Col style={{ 'padding': '0px' }} style={this.props.customStyle} className={`tilesView ${colOffset}`} key={product.id}>
...
export default connect(null, mapDispatchToProps)(ProductTilesView);